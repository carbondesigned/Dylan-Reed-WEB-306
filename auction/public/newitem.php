...
if(isset($_POST['submit'])) {
    ...
    $item = new Item($_SESSION['user']['id'], $_POST['category'], $_POST['name'], $_POST['price'], $_POST['description'], $_POST['end_date']);
				...
				<td>
					<select name="cat">
						...
						// (C) Retrieve all categories from the database and return them as an array of category objects
                            ...
                            Logger::getLogger()->error("Error retrieving categories: ", ['exception' => $e]);
                            die();
